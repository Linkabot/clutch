...
// alsoActiveFor: ['/code'] Learn-tab highlighting). The static
// learn/code/search route is listed before the learn/code/:slug param
// route so the intent is obvious to a reader, though React Router ranks
// the static segment higher regardless of source order.
