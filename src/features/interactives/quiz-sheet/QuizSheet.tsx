// QuizSheet: the bottom-anchored feedback sheet shown after a quiz answer
...
function QuizSheet({
  ...
  return (
    <div ref={rootRef} className={rootClassName} role="dialog" aria-labelledby={titleId}>
      ...
      <div className="quiz-sheet__panel">
        <div className="quiz-sheet__frame">
          ...
          <div className="quiz-sheet__actions">
            <button type="button" className="quiz-sheet__sign-page" onClick={onSignPage}>
              Sign page
            </button>
